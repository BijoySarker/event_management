    ...
    <div id="counter-section" class="pt_70 pb_70" style="background-image:url({{ asset('uploads/'.$home_counter->background) }})">
        <div class="container">
            <div class="row number-counters text-center">
                @if($home_counter->item1_title || $home_counter->item1_icon)
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="counters-item">
                            <i class="{{ $home_counter->item1_icon }}"></i>
                            <strong data-to="{{ $home_counter->item1_number ?? 0 }}">
                                {{ $home_counter->item1_number !== null ? $home_counter->item1_number : '' }}
                            </strong>
                ...
                @if($home_counter->item2_title || $home_counter->item2_icon)
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="counters-item">
                            <i class="{{ $home_counter->item2_icon }}"></i>
                            <strong data-to="{{ $home_counter->item2_number ?? 0 }}">
                                {{ $home_counter->item2_number !== null ? $home_counter->item2_number : '' }}
                            </strong>
                ...
                @if($home_counter->item3_title || $home_counter->item3_icon)
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="counters-item">
                            <i class="{{ $home_counter->item3_icon }}"></i>
                            <strong data-to="{{ $home_counter->item3_number ?? 0 }}">
                                {{ $home_counter->item3_number !== null ? $home_counter->item3_number : '' }}
                            </strong>
                ...
                @if($home_counter->item4_title || $home_counter->item4_icon)
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="counters-item">
                            <i class="{{ $home_counter->item4_icon }}"></i>
                            <strong data-to="{{ $home_counter->item4_number ?? 0 }}">
                                {{ $home_counter->item4_number !== null ? $home_counter->item4_number : '' }}
                            </strong>
