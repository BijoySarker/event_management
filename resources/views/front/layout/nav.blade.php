...
{{--                        </li>--}}
                        ...
                        <li>
                            <a class="smooth-scroll nav-link" href="organizers.html">Organizers</a>
                        </li>

                        <li>
                            <a class="smooth-scroll nav-link" href="photo-gallery.html">Photo Gallery</a>
                        </li>

                        <li>
                            <a class="smooth-scroll nav-link" href="sponsors.html">Sponsors</a>
                        </li>
