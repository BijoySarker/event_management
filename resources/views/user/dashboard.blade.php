            ...
            <div class="col-lg-9">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Phone: </th>
                            <td>@if(Auth::guard('web')->user()->phone != '')
                        ...
                        <tr>
                            <th>Address: </th>
                            <td>@if(Auth::guard('web')->user()->address != '')
                        ...
                        <tr>
                            <th>State: </th>
                            <td>@if(Auth::guard('web')->user()->state != '')
                        ...
                        <tr>
                            <th>City: </th>
                            <td>@if(Auth::guard('web')->user()->city != '')
                        ...
                        <tr>
                            <th>Country: </th>
                            <td>@if(Auth::guard('web')->user()->country != '')
